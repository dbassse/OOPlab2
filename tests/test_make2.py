...
from task_package.zad2 import Goods, Receipt
...
class TestReceipt:
    ...
    def test_add_goods(self):
        ...
        assert receipt.add_goods(goods1) == True
        assert receipt.get_count() == 1
        
        assert receipt.add_goods(goods2) == True
    ...
    def test_add_goods_max_capacity(self):
        ...
        assert receipt.add_goods(goods3) == False
        assert receipt.get_count() == 2
    ...
    def test_update_goods(self):
        ...
        assert receipt.update_goods(updated_goods) == True
    ...
    def test_update_goods_not_found(self):
        ...
        assert receipt.update_goods(goods) == False
    ...
    def test_remove_goods(self):
        ...
        assert receipt.remove_goods(100) == True
        assert receipt.get_count() == 1
    ...
    def test_remove_goods_not_found(self):
        ...
        assert receipt.remove_goods(999) == False
        assert receipt.get_count() == 1
    ...
    def test_get_total_sum(self):
        receipt = Receipt(12345)
        goods1 = Goods("100,Яблоки,2.5,10")  # 25.0
        goods2 = Goods("200,Бананы,1.8,15")  # 27.0
        goods3 = Goods("300,Апельсины,3.2,8")  # 25.6
...
class TestReceiptIntegration:
    ...
    def test_complete_workflow(self):
        ...
        assert receipt.add_goods(goods1) == True
        assert receipt.add_goods(goods2) == True
        assert receipt.add_goods(goods3) == True
...
class TestEdgeCases:
    ...
    def test_receipt_with_zero_size(self):
        ...
        assert receipt.add_goods(goods) == False
        assert receipt.get_count() == 0
